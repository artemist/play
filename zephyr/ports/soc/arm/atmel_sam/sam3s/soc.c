...
/**
 * @file
 * @brief Atmel SAM3S MCU series initialization code
 *
 * This module provides routines to initialize and support board-level hardware
 * for the Atmel SAM3S series processor.
 */
...
static ALWAYS_INLINE void clock_init(void)
{
...
#ifdef CONFIG_SOC_ATMEL_SAM3S_EXT_SLCK
...
#endif /* CONFIG_SOC_ATMEL_SAM3S_EXT_SLCK */

#ifdef CONFIG_SOC_ATMEL_SAM3S_EXT_MAINCK
	/*
...
#ifdef CONFIG_SOC_ATMEL_SAM3S_WAIT_MODE
	/*
...
#endif /* CONFIG_SOC_ATMEL_SAM3S_EXT_MAINCK */
	...
	PMC->CKGR_PLLAR = CKGR_PLLAR_ONE
			  | CKGR_PLLAR_MULA(CONFIG_SOC_ATMEL_SAM3S_PLLA_MULA)
			  | CKGR_PLLAR_PLLACOUNT(0x3Fu)
			  | CKGR_PLLAR_DIVA(CONFIG_SOC_ATMEL_SAM3S_PLLA_DIVA);
...
void z_arm_platform_init(void)
{
	 ...
	 * (MCK) frequency. Look at table 44.73 in the SAM3S datasheet.
	 ...
	 * TODO: Add code to handle SAM3SD devices that have 2 EFCs.
	 */
