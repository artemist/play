...
pub type R = crate::R<RPio0_11Spec>;
#[doc = "Register `R_PIO0_11` writer"]
pub type W = crate::W<RPio0_11Spec>;
...
impl FuncR {
    ...
    pub const fn variant(&self) -> Option<Func> {
        match self.bits {
            ...
            2 => Some(Func::SelectsFunctionAd0),
    ...
    #[inline(always)]
    pub fn is_selects_function_ad0(&self) -> bool {
        *self == Func::SelectsFunctionAd0
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "Selects function AD0."]
    #[inline(always)]
    pub fn selects_function_ad0(self) -> &'a mut crate::W<REG> {
        self.variant(Func::SelectsFunctionAd0)
    }
    #[doc = "Selects function CT32B0_MAT3."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn func(&mut self) -> FuncW<RPio0_11Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> ModeW<RPio0_11Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    #[must_use]
    pub fn hys(&mut self) -> HysW<RPio0_11Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 7 - Selects Analog/Digital mode"]
    #[inline(always)]
    #[must_use]
    pub fn admode(&mut self) -> AdmodeW<RPio0_11Spec> {
        AdmodeW::new(self, 7)
    }
    #[doc = "Bit 10 - Selects pseudo open-drain mode."]
    #[inline(always)]
    #[must_use]
    pub fn od(&mut self) -> OdW<RPio0_11Spec> {
        OdW::new(self, 10)
    }
}
...
pub struct RPio0_11Spec;
impl crate::RegisterSpec for RPio0_11Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`r_pio0_11::R`](R) reader structure"]
impl crate::Readable for RPio0_11Spec {}
#[doc = "`write(|w| ..)` method takes [`r_pio0_11::W`](W) writer structure"]
impl crate::Writable for RPio0_11Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets R_PIO0_11 to value 0xd0"]
impl crate::Resettable for RPio0_11Spec {
