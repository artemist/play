...
pub type R = crate::R<RPio1_0Spec>;
#[doc = "Register `R_PIO1_0` writer"]
pub type W = crate::W<RPio1_0Spec>;
...
impl FuncR {
    ...
    pub const fn variant(&self) -> Option<Func> {
        match self.bits {
            ...
            2 => Some(Func::SelectsFunctionAd1),
    ...
    #[inline(always)]
    pub fn is_selects_function_ad1(&self) -> bool {
        *self == Func::SelectsFunctionAd1
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "Selects function AD1."]
    #[inline(always)]
    pub fn selects_function_ad1(self) -> &'a mut crate::W<REG> {
        self.variant(Func::SelectsFunctionAd1)
    }
    #[doc = "Selects function CT32B1_CAP0."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn func(&mut self) -> FuncW<RPio1_0Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> ModeW<RPio1_0Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    #[must_use]
    pub fn hys(&mut self) -> HysW<RPio1_0Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 7 - Selects Analog/Digital mode"]
    #[inline(always)]
    #[must_use]
    pub fn admode(&mut self) -> AdmodeW<RPio1_0Spec> {
        AdmodeW::new(self, 7)
    }
    #[doc = "Bit 10 - Selects pseudo open-drain mode."]
    #[inline(always)]
    #[must_use]
    pub fn od(&mut self) -> OdW<RPio1_0Spec> {
        OdW::new(self, 10)
    }
}
