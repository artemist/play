...
pub enum Func {
    ...
    #[doc = "1: Selects function CT16B0_CAP1."]
    SelectsFunctionCt1 = 1,
    #[doc = "2: Selects function RXD."]
    SelectsFunctionRxd = 2,
}
...
impl FuncR {
    ...
    pub const fn variant(&self) -> Option<Func> {
        match self.bits {
            ...
            2 => Some(Func::SelectsFunctionRxd),
            _ => None,
        }
    }
    ...
    #[doc = "Selects function CT16B0_CAP1."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn func(&mut self) -> FuncW<Pio3_4Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> ModeW<Pio3_4Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    #[must_use]
    pub fn hys(&mut self) -> HysW<Pio3_4Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 10 - Selects pseudo open-drain mode."]
    #[inline(always)]
    #[must_use]
    pub fn od(&mut self) -> OdW<Pio3_4Spec> {
        OdW::new(self, 10)
    }
}
