...
pub enum Func {
    ...
    #[doc = "1: Selects function DSR."]
    SelectsFunctionDsr = 1,
    #[doc = "2: Selects function CT16B0_MAT1."]
    SelectsFunctionCt1 = 2,
    #[doc = "3: Selects function RXD."]
    SelectsFunctionRxd = 3,
}
...
impl FuncR {
    ...
    pub const fn variant(&self) -> Option<Func> {
        match self.bits {
            ...
            1 => Some(Func::SelectsFunctionDsr),
            2 => Some(Func::SelectsFunctionCt1),
            3 => Some(Func::SelectsFunctionRxd),
            _ => None,
        }
    }
    ...
    #[doc = "Selects function DSR."]
    #[inline(always)]
    pub fn is_selects_function_dsr(&self) -> bool {
        *self == Func::SelectsFunctionDsr
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "Selects function DSR."]
    #[inline(always)]
    pub fn selects_function_dsr(self) -> &'a mut crate::W<REG> {
        self.variant(Func::SelectsFunctionDsr)
    }
    #[doc = "Selects function CT16B0_MAT1."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn func(&mut self) -> FuncW<Pio3_1Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> ModeW<Pio3_1Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    #[must_use]
    pub fn hys(&mut self) -> HysW<Pio3_1Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 10 - Selects pseudo open-drain mode."]
    #[inline(always)]
    #[must_use]
    pub fn od(&mut self) -> OdW<Pio3_1Spec> {
        OdW::new(self, 10)
    }
}
