...
impl FuncR {
    ...
    pub const fn variant(&self) -> Option<Func> {
        match self.bits {
            0 => Some(Func::SelectsFunctionSwd),
            1 => Some(Func::SelectsFunctionPio),
            2 => Some(Func::SelectsFunctionAd4),
    ...
    #[inline(always)]
    pub fn is_selects_function_swd(&self) -> bool {
        *self == Func::SelectsFunctionSwd
    }
    ...
    #[inline(always)]
    pub fn is_selects_function_ad4(&self) -> bool {
        *self == Func::SelectsFunctionAd4
    }
    ...
    REG::Ux: From<u8>,
{
    #[doc = "Selects function SWDIO."]
    #[inline(always)]
    pub fn selects_function_swd(self) -> &'a mut crate::W<REG> {
        self.variant(Func::SelectsFunctionSwd)
    }
    #[doc = "Selects function PIO1_3."]
    #[inline(always)]
    ...
    #[doc = "Selects function AD4."]
    #[inline(always)]
    pub fn selects_function_ad4(self) -> &'a mut crate::W<REG> {
        self.variant(Func::SelectsFunctionAd4)
    }
    #[doc = "Selects function CT32B1_MAT2."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn func(&mut self) -> FuncW<SwdioPio1_3Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> ModeW<SwdioPio1_3Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    #[must_use]
    pub fn hys(&mut self) -> HysW<SwdioPio1_3Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 7 - Selects Analog/Digital mode"]
    #[inline(always)]
    #[must_use]
    pub fn admode(&mut self) -> AdmodeW<SwdioPio1_3Spec> {
        AdmodeW::new(self, 7)
    }
    #[doc = "Bit 10 - Selects pseudo open-drain mode."]
    #[inline(always)]
    #[must_use]
    pub fn od(&mut self) -> OdW<SwdioPio1_3Spec> {
        OdW::new(self, 10)
    }
}
...
pub struct SwdioPio1_3Spec;
impl crate::RegisterSpec for SwdioPio1_3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`swdio_pio1_3::R`](R) reader structure"]
impl crate::Readable for SwdioPio1_3Spec {}
#[doc = "`write(|w| ..)` method takes [`swdio_pio1_3::W`](W) writer structure"]
impl crate::Writable for SwdioPio1_3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SWDIO_PIO1_3 to value 0xd0"]
impl crate::Resettable for SwdioPio1_3Spec {
