...
pub enum Func {
    ...
    #[doc = "1: Selects function CT16B1_CAP1."]
    SelectsFunctionCt1 = 1,
    #[doc = "2: Selects function TXD."]
    SelectsFunctionTxd = 2,
}
...
impl FuncR {
    ...
    pub const fn variant(&self) -> Option<Func> {
        match self.bits {
            ...
            2 => Some(Func::SelectsFunctionTxd),
            _ => None,
        }
    }
    ...
    #[doc = "Selects function CT16B1_CAP1."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn func(&mut self) -> FuncW<Pio3_5Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> ModeW<Pio3_5Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    #[must_use]
    pub fn hys(&mut self) -> HysW<Pio3_5Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 10 - Selects pseudo open-drain mode."]
    #[inline(always)]
    #[must_use]
    pub fn od(&mut self) -> OdW<Pio3_5Spec> {
        OdW::new(self, 10)
    }
}
