...
pub enum Func {
    ...
    #[doc = "1: Selects function DCD."]
    SelectsFunctionDcd = 1,
    #[doc = "2: Selects function CT16B0_MAT2."]
    SelectsFunctionCt1 = 2,
    #[doc = "3: Selects function SCK1."]
    SelectsFunctionSck = 3,
}
...
impl FuncR {
    ...
    pub const fn variant(&self) -> Option<Func> {
        match self.bits {
            ...
            1 => Some(Func::SelectsFunctionDcd),
            2 => Some(Func::SelectsFunctionCt1),
            3 => Some(Func::SelectsFunctionSck),
            _ => None,
        }
    }
    ...
    #[doc = "Selects function DCD."]
    #[inline(always)]
    pub fn is_selects_function_dcd(&self) -> bool {
        *self == Func::SelectsFunctionDcd
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "Selects function DCD."]
    #[inline(always)]
    pub fn selects_function_dcd(self) -> &'a mut crate::W<REG> {
        self.variant(Func::SelectsFunctionDcd)
    }
    #[doc = "Selects function CT16B0_MAT2."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn func(&mut self) -> FuncW<Pio3_2Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> ModeW<Pio3_2Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    #[must_use]
    pub fn hys(&mut self) -> HysW<Pio3_2Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 10 - Selects pseudo open-drain mode."]
    #[inline(always)]
    #[must_use]
    pub fn od(&mut self) -> OdW<Pio3_2Spec> {
        OdW::new(self, 10)
    }
}
