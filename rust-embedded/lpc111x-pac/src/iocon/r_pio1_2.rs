...
pub type R = crate::R<RPio1_2Spec>;
#[doc = "Register `R_PIO1_2` writer"]
pub type W = crate::W<RPio1_2Spec>;
...
impl FuncR {
    ...
    pub const fn variant(&self) -> Option<Func> {
        match self.bits {
            ...
            2 => Some(Func::SelectsFunctionAd3),
    ...
    #[inline(always)]
    pub fn is_selects_function_ad3(&self) -> bool {
        *self == Func::SelectsFunctionAd3
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "Selects function AD3."]
    #[inline(always)]
    pub fn selects_function_ad3(self) -> &'a mut crate::W<REG> {
        self.variant(Func::SelectsFunctionAd3)
    }
    #[doc = "Selects function CT32B1_MAT1."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn func(&mut self) -> FuncW<RPio1_2Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> ModeW<RPio1_2Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    #[must_use]
    pub fn hys(&mut self) -> HysW<RPio1_2Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 7 - Selects Analog/Digital mode"]
    #[inline(always)]
    #[must_use]
    pub fn admode(&mut self) -> AdmodeW<RPio1_2Spec> {
        AdmodeW::new(self, 7)
    }
    #[doc = "Bit 10 - Selects pseudo open-drain mode."]
    #[inline(always)]
    #[must_use]
    pub fn od(&mut self) -> OdW<RPio1_2Spec> {
        OdW::new(self, 10)
    }
}
