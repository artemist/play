...
impl FuncR {
    ...
    pub const fn variant(&self) -> Option<Func> {
        match self.bits {
            0 => Some(Func::SelectsFunctionSwc),
            1 => Some(Func::SelectsFunctionPio),
            2 => Some(Func::SelectsFunctionSck),
            3 => Some(Func::SelectsFunctionCt1),
            _ => None,
        }
    }
    #[doc = "Selects function SWCLK."]
    #[inline(always)]
    pub fn is_selects_function_swc(&self) -> bool {
        *self == Func::SelectsFunctionSwc
    }
    ...
    #[doc = "Selects function SCK0 (only if pin SWCLK/PIO0_10/SCK0/CT16B0_MAT2 selected in Table 147)."]
    #[inline(always)]
    ...
    REG::Ux: From<u8>,
{
    #[doc = "Selects function SWCLK."]
    #[inline(always)]
    pub fn selects_function_swc(self) -> &'a mut crate::W<REG> {
        self.variant(Func::SelectsFunctionSwc)
    }
    #[doc = "Selects function PIO0_10."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn func(&mut self) -> FuncW<SwclkPio0_10Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> ModeW<SwclkPio0_10Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    #[must_use]
    pub fn hys(&mut self) -> HysW<SwclkPio0_10Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 10 - Selects pseudo open-drain mode."]
    #[inline(always)]
    #[must_use]
    pub fn od(&mut self) -> OdW<SwclkPio0_10Spec> {
        OdW::new(self, 10)
    }
}
...
pub struct SwclkPio0_10Spec;
impl crate::RegisterSpec for SwclkPio0_10Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`swclk_pio0_10::R`](R) reader structure"]
impl crate::Readable for SwclkPio0_10Spec {}
#[doc = "`write(|w| ..)` method takes [`swclk_pio0_10::W`](W) writer structure"]
impl crate::Writable for SwclkPio0_10Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SWCLK_PIO0_10 to value 0xd0"]
impl crate::Resettable for SwclkPio0_10Spec {
