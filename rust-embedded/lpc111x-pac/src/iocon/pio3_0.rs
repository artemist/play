...
pub enum Func {
    ...
    #[doc = "1: Selects function DTR."]
    SelectsFunctionDtr = 1,
    #[doc = "2: Selects function CT16B0_MAT0."]
    SelectsFunctionCt1 = 2,
    #[doc = "3: Selects function TXD."]
    SelectsFunctionTxd = 3,
}
...
impl FuncR {
    ...
    pub const fn variant(&self) -> Option<Func> {
        match self.bits {
            ...
            1 => Some(Func::SelectsFunctionDtr),
            2 => Some(Func::SelectsFunctionCt1),
            3 => Some(Func::SelectsFunctionTxd),
            _ => None,
        }
    }
    ...
    #[doc = "Selects function DTR."]
    #[inline(always)]
    pub fn is_selects_function_dtr(&self) -> bool {
        *self == Func::SelectsFunctionDtr
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "Selects function DTR."]
    #[inline(always)]
    pub fn selects_function_dtr(self) -> &'a mut crate::W<REG> {
        self.variant(Func::SelectsFunctionDtr)
    }
    #[doc = "Selects function CT16B0_MAT0."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn func(&mut self) -> FuncW<Pio3_0Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> ModeW<Pio3_0Spec> {
        ModeW::new(self, 3)
    }
    #[doc = "Bit 5 - Hysteresis."]
    #[inline(always)]
    #[must_use]
    pub fn hys(&mut self) -> HysW<Pio3_0Spec> {
        HysW::new(self, 5)
    }
    #[doc = "Bit 10 - Selects pseudo open-drain mode."]
    #[inline(always)]
    #[must_use]
    pub fn od(&mut self) -> OdW<Pio3_0Spec> {
        OdW::new(self, 10)
    }
}
