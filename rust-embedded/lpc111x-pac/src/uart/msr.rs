...
#[doc = "Field `DCTS` reader - Delta CTS. Set upon state change of input CTS. Cleared on a MSR read."]
...
#[doc = "Field `DDSR` reader - Delta DSR. Set upon state change of input DSR. Cleared on a MSR read."]
...
#[doc = "Field `DDCD` reader - Delta DCD. Set upon state change of input DCD. Cleared on a MSR read."]
