...
impl IntidR {
    ...
    #[inline(always)]
    pub fn is_4_modem_interrup(&self) -> bool {
        *self == Intid::_4ModemInterrup
    }
}
#[doc = "Field `FIFOENABLE` reader - These bits are equivalent to FCR\\[0\\]."]
