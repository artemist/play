...
#[doc = "Field `MODE` reader - Auto-baud mode select"]
...
#[doc = "Field `MODE` writer - Auto-baud mode select"]
...
#[doc = "Field `AUTORESTART` reader - Restart enable"]
...
#[doc = "Field `AUTORESTART` writer - Restart enable"]
...
#[doc = "Field `ABEOINTCLR` reader - End of auto-baud interrupt clear (write only accessible)"]
...
#[doc = "Field `ABEOINTCLR` writer - End of auto-baud interrupt clear (write only accessible)"]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Writing a 0 has no impact."]
    #[inline(always)]
    pub fn noimpact(self) -> &'a mut crate::W<REG> {
        self.variant(Abeointclr::Noimpact)
    }
    #[doc = "Writing a 1 will clear the corresponding interrupt in the IIR."]
    #[inline(always)]
...
#[doc = "Field `ABTOINTCLR` reader - Auto-baud time-out interrupt clear (write only accessible)"]
...
#[doc = "Field `ABTOINTCLR` writer - Auto-baud time-out interrupt clear (write only accessible)"]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn noimpact(self) -> &'a mut crate::W<REG> {
        self.variant(Abtointclr::Noimpact)
    }
    #[doc = "Writing a 1 will clear the corresponding interrupt in the IIR."]
    #[inline(always)]
    pub fn clear(self) -> &'a mut crate::W<REG> {
